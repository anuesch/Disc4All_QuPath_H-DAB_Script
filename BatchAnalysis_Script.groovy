...
//Instead of the different components the different antibodies can be used.

//if you ran the automatic tissue detection delete all except one component and replace its values and name with Region

//---------------------------------------------------------------------------------------------------------------//
//Component1 = The name of your classification for the tissue e.g. NP
...
runObjectClassifier("ObjectClassifier_Component_1") // replace with Objectclassifier with Classification name eg. Objectclassifier_NP
//---------------------------------------------------------------------------------------------------------------//

//can be deleted if only one region analysed
//---------------------------------------------------------------------------------------------------------------//
//Component2 = The name of your classification for the tissue e.g. iAF
...
runObjectClassifier("ObjectClassifier_Component2") // replace with Objectclassifier with Classification name eg. Objectclassifier_iAF
//---------------------------------------------------------------------------------------------------------------//


//can be deleted if only two regions analysed
//---------------------------------------------------------------------------------------------------------------//
//Component3 = The name of your classification for the tissue e.g. oAF
...
//can be deleted if only three regions analysed or copied if more than 4 are being analysed
//---------------------------------------------------------------------------------------------------------------//
//Component4 = The name of your classification for the tissue e.g. NP
